let Ui_chart_accessory = class {
    ...
    UI_EVENT(){
        ...
        var chart    = document.getElementById('chart_accessory').getContext('2d'),
        ...
        //**************************************************************************
        var ctx = document.getElementById('graph_accessory').getContext('2d');
...
let chart_accessory_ui = new Ui_chart_accessory();