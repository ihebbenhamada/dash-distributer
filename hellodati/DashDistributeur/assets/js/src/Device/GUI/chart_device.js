let Ui_chart_device = class {
    ...
    UI_EVENT(){
        ...
        var chart    = document.getElementById('chart_device').getContext('2d'),
        ...
        //**************************************************************************
        var ctx = document.getElementById('graph_device').getContext('2d');
...
let chart_device_ui = new Ui_chart_device();