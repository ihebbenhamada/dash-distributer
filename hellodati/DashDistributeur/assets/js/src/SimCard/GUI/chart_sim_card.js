let Ui_chart_sim_card = class {
    ...
    UI_EVENT(){
        ...
        var chart    = document.getElementById('chart_sim_card').getContext('2d'),
        ...
        //**************************************************************************
        var ctx = document.getElementById('graph_sim_card').getContext('2d');
...
let chart_sim_card_ui = new Ui_chart_sim_card();