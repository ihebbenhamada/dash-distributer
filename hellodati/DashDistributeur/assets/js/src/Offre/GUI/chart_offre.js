let Ui_chart_offre = class {
    ...
    UI_EVENT(){
        ...
        var chart    = document.getElementById('chart_offre').getContext('2d'),
        ...
        //**************************************************************************
        var ctx = document.getElementById('graph_offre').getContext('2d');
...
let chart_offre_ui = new Ui_chart_offre();