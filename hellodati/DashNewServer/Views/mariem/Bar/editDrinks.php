<div class="addForm_container" DATI-PAGE="editDrinks">
            ...
            <div class="body_form">
                <div class="body_main_container">
                    <div class="main_container_left">
                        ...
                        <input type="text" DATI-ID="val_title" placeholder="title">
                        <label for="description">Description :</label>
                        <textarea  DATI-ID="val_desc" name="" id=""></textarea>

                    </div>
                    <div class="main_container_right">
                        <label for="image">Image :</label>
                        <div class="imageUploader" DATI-COMPOSENT="Uploader" DATI-ID="uploadIamgeRestau"
