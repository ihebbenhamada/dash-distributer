<div class="addForm_container"  DATI-PAGE="addFormServices" FORM-ID="form_add_Restau" DATI-SEND="restaurantCard_ui.VERIF_FORM_ADD_RESTAU">
                                                                      ...
                                                                      <div class="title">
                                                                               ...
                                                                               <div class="shifts">
                                                                                   <div class="open_close">
                                                                                       <div class="title_s">
                                                                                           <p>Opening</p>
                                                                                           <input type="text" name="" placeholder="00:00"  DATI-OPENING-TIME>
                                                                                       </div>
                                                                                       <div class="img_s">
                                                                                   ...
                                                                                   <div class="open_close">
                                                                                       <div class="title_sc">
                                                                                           <p>Closing</p>
                                                                                           <input type="text" name=""  placeholder="00:00" DATI-CLOSING-TIME>
                                                                                       </div>
                                                                                       <div class="img_s">
                                                                               ...
                                                                               <div class="bt-addS">
                                                                                   <div class="button_shifts" onclick="Shifts_ui.ADD_SHIFT_DAY('mon',['8:00','10:00']);">
