<div class="addForm_container" FORM-ID="form_Update_Restau" DATI-SEND="restaurantCard_ui.VERIF_FORM_EDIT_RESTAU"  DATI-PAGE="editRestauPage">
                        ...
                        <div class="body_form">
                            <div class="body_main_container">
                                <div class="main_container_left">
                                    ...
                                    <input DATI-ID="val_title" DATI-INPUT-NAME="title" type="text" placeholder="title" value="" DATI-INPUT-TITLE-REST-UPDATE>
                                    <label for="description">Description :</label>
                                    <textarea DATI-ID="val_desc"  DATI-INPUT-NAME="description" name="" id="" value=""  DATI-INPUT-DESCRIPTION-REST-UPDATE></textarea>
                                </div>
