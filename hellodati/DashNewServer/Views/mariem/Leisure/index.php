<div class="restaurants_container"  DATI-PAGE="Leisure">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addLeisureServices"  DATI-DISPLAY="grid">
...
<!-- end button  -->
  ...
  CARDS-BEFORE-LINK="restaurantCard_ui.SETSELECTED"
   DATI-SWITECH-TOGGOLE="iLeisureCard.ENABLE_SERVICE"
  >
  <div DATI-COMPOSENT="RestaurantCards-icon-detail"
      ...
      DETAIL-IMAGE="leisureCard_ui.selectedLeisure.img"></div>

       <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editLeisurePage"  dati-display="grid" onclick="leisureCard_ui.SETSELECTED_detail(this)"></div>
