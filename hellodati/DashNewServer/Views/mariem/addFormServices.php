<div class="addForm_container"  DATI-PAGE="addFormServices">
                        ...
                        <!-- end add language modal  -->
                          ...
                          <div class="openingAndTimes">
                                              ...
                                              <div>
                                                ...
                                                <div  class="switcherContainer"
                                                              DATI-COMPOSENT="switcherContainer"
                                                              DATI-ID="switcherPROMOAddRestau"
                                                              DATI-UPDATE="showPageAddRestau"
                                                              DATI-CHANGE="restaurantCard_ui.ENABLE_PROMO()">
                                                   </div>
                                                  <!-- end switcher  -->
                                              </div>
                                              <!-- end no promotion  -->
                                              <!-- has promotion  -->
                                              <div class="has_promo" dati-id="Promo_Restau" style="display:none">
