<div class="restaurants_container"  DATI-PAGE="Meetings">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addMeetingServices"  DATI-DISPLAY="grid">
...
<!-- end button  -->
  ...
  DATI-SWITECH-TOGGOLE="imeetingCard.ENABLE_SERVICE"
  >
     ...
     <div DATI-COMPOSENT="RestaurantCards-icon-detail"
      ...
      DETAIL-IMAGE="meetingCard_ui.selectedMeeting.img"></div>

          <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editMeetingPage"  dati-display="grid" onclick="meetingCard_ui.SETSELECTED_detail(this)"></div>
