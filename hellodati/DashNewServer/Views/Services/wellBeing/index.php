<div class="restaurants_container"  DATI-PAGE="Well-being" DATI-DISPLAY="flex">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addWellBServices" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   WellBeing &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Form" DATI-DISPLAY="grid">
...
<!-- end button  -->
  ...
  DATI-SWITECH-TOGGOLE="iWellBeingCard.ENABLE_WELLBEING"
  >
  <div DATI-COMPOSENT="RestaurantCards-icon-detail"
      ...
      DETAIL-IMAGE="WellBeingCard_ui.selectedLeisure.image"></div>

       <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editWellBPage" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   WellBeing &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Form"  dati-display="grid" onclick="WellBeingCard_ui.SETSELECTED_detail(this)"></div>
