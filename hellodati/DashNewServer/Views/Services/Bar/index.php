<div class="restaurants_container"  DATI-PAGE="Bar" DATI-DISPLAY="flex">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addBarServices" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Bar &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Add Form" DATI-DISPLAY="grid">
...
<!-- end button  -->
 ...
 CARDS-LINK="Bar\/Contents"
   CARDS-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Bar &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  "
 DATI-SWITECH-TOGGOLE="iBarCard.ENABLE_BAR"
  ...
  >
    ...
    <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editBarPage" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Bar &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Form" dati-display="grid" onclick="barCard_ui.SETSELECTED_detail(this)"></div>
