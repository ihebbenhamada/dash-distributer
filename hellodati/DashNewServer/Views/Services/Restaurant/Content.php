<div class="service_content"   DATI-PAGE="Restaurant/Contents" >
  ...
  DATI-TITLE-HEADER="restaurantCard_ui.selectedRest.title"
  DATI-ICON-HEADER="/assets/img/serviceIcon/restaurantWhite.svg"
  DATI-CANCEL-FORM="Categories_ui.TEST_CANCEL_FORM()"
...
<!-- add button  -->
<div class="add_button_restau"  DATI-ADD-BT="display" DATI-LINK="addDish" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Restaurant &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Add Dish Form" DATI-DISPLAY="grid" >
...
<!-- end button  -->
 ...
 <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editDishPage" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Restaurant &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Dish Form"  dati-display="grid" onclick="restauContent_ui.SETSELECTED_detail(this)"></div>
