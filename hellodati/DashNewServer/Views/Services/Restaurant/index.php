<div class="restaurants_container"  DATI-PAGE="Restaurant" DATI-DISPLAY="flex">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addFormServices" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Restaurant &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Add Form" DATI-DISPLAY="grid">
...
<!-- end button  -->
  ...
  CARDS-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Restaurant &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  "
  ...
  >
    ...
    <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editRestauPage" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Restaurant &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Form"  dati-display="grid" onclick="restaurantCard_ui.SETSELECTED_detail(this)"></div>
