<div class="restaurants_container"  DATI-PAGE="Events" DATI-DISPLAY="flex">

<!-- add button  -->
<div class="add_button_restau"  DATI-LINK="addEventServices" DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Event &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Add Form"  DATI-DISPLAY="grid">
...
<!-- end button  -->
  ...
  DATI-SWITECH-TOGGOLE="ieventCard.ENABLE_EVENT"
  >
  ...
  <div DATI-COMPOSENT="RestaurantCards-icon-edit" DATI-LINK="editEventPage"  DATI-PATH="Services &nbsp;&nbsp;&nbsp;> &nbsp;&nbsp;&nbsp;   Event &nbsp;&nbsp;&nbsp;    >  &nbsp;&nbsp;&nbsp;  Edit Form" dati-display="grid" onclick="eventCard_ui.SETSELECTED_detail(this)"></div>
